...
/obj/item/clothing/under/hawking
	name = "Rugged Mechanic Outfit"
	desc = "It's covered in oil stains and some of the fibers are torn. The name \"Hawking\" is sewn onto a patch on the tank top."
	icon_state = "hawking"
	item_state = "hawking"
	item_color = "hawking"
...
/obj/item/clothing/under/dress/dress_firepink
	name = "flame dress"
	desc = "A small black dress with deep pink flames print on it."
	icon_state = "dress_firepink"
	item_color = "dress_firepink"
