...
/datum/TCS_Compiler
	...
	proc/Run(var/datum/signal/signal)
		...
		interpreter.SetVar("$msulaco",	1461)
		interpreter.SetVar("$mhaz",	1363)
		interpreter.SetVar("$mcom",	1365)
		interpreter.SetVar("$mbra",1367)
		interpreter.SetVar("$malp",	1369)
		interpreter.SetVar("$mcha",	1371)
		interpreter.SetVar("$mmpo",	1379)
		interpreter.SetVar("$mdel",1381)
