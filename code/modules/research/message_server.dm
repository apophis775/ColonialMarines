...
/obj/machinery/blackbox_recorder
	...
	var/list/msg_msul = list()
	var/list/msg_mhaz = list()
	var/list/msg_mcom = list()
	var/list/msg_malp = list()
	var/list/msg_mbra = list()
	var/list/msg_mcha = list()
	var/list/msg_mdel = list()
	var/list/msg_mmpo = list()
