...
/mob/living/verb/ghost()
	...
	if(stat == DEAD)
		...
		var/response = alert(src, "Are you -sure- you want to ghost?\n(You are alive. If you ghost, you will not be able to play as a Marine for the rest of the round)","Are you sure you want to ghost?","Ghost","Stay in body")
...
/mob/dead/observer/verb/analyze_air()
	...
	if(total_moles)
		...
		var/plasma_concentration = environment.phoron/total_moles

		var/unknown_concentration =  1-(o2_concentration+n2_concentration+co2_concentration+plasma_concentration)
		if(abs(n2_concentration - N2STANDARD) < 20)
			src << "\blue Nitrogen: [round(n2_concentration*100)]%"
		else
			src << "\red Nitrogen: [round(n2_concentration*100)]%"

		if(abs(o2_concentration - O2STANDARD) < 2)
			src << "\blue Oxygen: [round(o2_concentration*100)]%"
		else
			src << "\red Oxygen: [round(o2_concentration*100)]%"

		if(co2_concentration > 0.01)
			src << "\red CO2: [round(co2_concentration*100)]%"
		else
			src << "\blue CO2: [round(co2_concentration*100)]%"

		if(plasma_concentration > 0.01)
			src << "\red Plasma: [round(plasma_concentration*100)]%"

		if(unknown_concentration > 0.01)
			src << "\red Unknown: [round(unknown_concentration*100)]%"

		src << "\blue Temperature: [round(environment.temperature-T0C)]&deg;C"
