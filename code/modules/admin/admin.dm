...
/proc/message_admins(var/msg)
	msg = "<span class=\"adminlog\"><span class=\"prefix\">ADMIN LOG:</span> <span class=\"message\">[msg]</span></span>"
	log_adminwarn(msg)
...
/proc/msg_admin_attack(var/text) //Toggleable Attack Messages
	log_attack(text)
	var/rendered = "<span class=\"adminlog\"><span class=\"prefix\">ATTACK:</span> <span class=\"message\">[text]</span></span>"
	for(var/client/C in admins)
		if(R_ADMIN & C.holder.rights)
	...
	if (M.client)
		if(!istype(M, /mob/new_player))
			...
			body += {"<br><br>
				...
				<A href='?src=\ref[src];simplemake=hunter;mob=\ref[M]'>Warrior</A> |
				...
				<A href='?src=\ref[src];simplemake=queen;mob=\ref[M]'>Queen</A> \]<br>
...
/datum/admins/proc/togglelooc()
	set category = "Server"
	set desc="Toggle dis bitch (locally)"
