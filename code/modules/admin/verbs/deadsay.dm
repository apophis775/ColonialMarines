/client/proc/dsay(msg as text)
	...
	var/rendered = "<span class='game deadsay'><span class='prefix'>DEAD:</span> <span class='name'>[stafftype]([src.holder.fakekey ? pick("Admin") : src.key])</span> says, <span class='message'>\"[msg]\"</span></span>"
