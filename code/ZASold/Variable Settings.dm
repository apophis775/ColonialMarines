...
/vs_control
	...
	var/airflow_heavy_pressure = 300
	...
	var/airflow_dense_pressure = 300
...
/vs_control/proc/SetDefault(var/mob/user)
	...
	"ZAS - Heavenly", "ZAS - Forgiving","ZAS - Normal", "ZAS - Dangerous", "ZAS - Hellish")
	...
	switch(def)
		...
		if("ZAS - Heavenly")
			...
			airflow_heavy_pressure = 500
			airflow_dense_pressure = 700
			airflow_stun_pressure = 550
			airflow_stun_cooldown = 500
			airflow_stun = 0
			airflow_damage = 0
