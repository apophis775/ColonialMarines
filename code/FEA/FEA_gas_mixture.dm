...
/datum/gas_mixture
	...
	check_gas_mixture(datum/gas_mixture/sharer)
		...
		var/delta_toxins = (toxins_archived - sharer.phoron_archived)/5
	...
	check_turf(turf/model)
		...
		var/delta_toxins = (toxins_archived - model.phoron)/5
	...
	share(datum/gas_mixture/sharer)
		...
		var/delta_toxins = QUANTIZE(toxins_archived - sharer.phoron_archived)/5
	...
	mimic(turf/model, border_multiplier)
		...
		var/delta_toxins = QUANTIZE(toxins_archived - model.phoron)/5
