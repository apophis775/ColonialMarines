...
/obj/item/weapon/book/manual/millaw
	...
	dat = {"<html>
<body>
<b>Note</b>: the Commander of the NMV Sulaco and its marines are not above the marine law and code of conduct. Current laws apply to all personnel, save for higher military officials from Nanotrasen or unless stated otherwise.<br><br>
<b>Current marine laws<b>:<br>
...
/obj/item/weapon/book/manual/milmanual
	...
	<u>Assisting in evacuation</u>- Should the NMV Sulaco be no longer able to handle the immediate threat, attack, or continue operating saftely, an evacuation from the vessel may be called. Should this happen, military officers and law enforcement agents are expected to assist in ensuring all personnel make it to the escape pods saftely.
	"}


/obj/item/weapon/book/manual/biomanual
	name = "Hazteam Manual"
	icon_state = "bookNuclear"
	author = "Nanotrasen Military"
	title = "Hazardous Materials Team Manual"
