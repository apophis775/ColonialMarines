...
/datum/game_mode/proc/send_intercept()
	...
	for(var/mob/living/carbon/human/man in player_list) if(man.client && man.mind)
		...
		if (special_role == "Wizard" || special_role == "Ninja" || special_role == "Syndicate" || special_role == "Xeno")
...
datum/game_mode/proc/get_players_for_survivor()
	...
	return players		// Returns: The number of people who had the antagonist role set to yes, regardless of recomended_enemies, if that number is greater than recommended_enemies
							//			recommended_enemies if the number of people with that role set to yes is less than recomended_enemies,
							//			Less if there are not enough valid players in the game entirely to make recommended_enemies.
