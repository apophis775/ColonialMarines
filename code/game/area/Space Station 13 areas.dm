...
/area/shuttle/marine/base
	name = "\improper Marine Shuttle"
	icon_state = "shuttlered"

/area/shuttle/marine/station
	name = "\improper Marine Shuttle"
	icon_state = "shuttlered2"

/area/marinebase/medbay
	name = "\improper Marine Base Medical Bay"

/area/marinebase/bridge
	name = "\improper Marine Base Bridge"

/area/marinebase/bridgemaint
	name = "\improper Marine Base Bridge Maintenance"

/area/marinebase/meetingroom
	name = "\improper Marine Base Meeting Room"

/area/marinebase/mainhall
	name = "\improper Marine Base Hallway"

/area/marinebase/dorms
	name = "\improper Marine Base Dorms"
