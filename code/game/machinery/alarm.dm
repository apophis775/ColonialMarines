...
/obj/machinery/alarm/proc/overall_danger_level()
	...
	var/plasma_dangerlevel = get_danger_level(environment.phoron*partial_pressure, TLV["plasma"])
...
"}
	...
	var/plasma_dangerlevel = get_danger_level(environment.phoron*partial_pressure, current_settings)
	var/plasma_percent = round(environment.phoron / total * 100, 2)
