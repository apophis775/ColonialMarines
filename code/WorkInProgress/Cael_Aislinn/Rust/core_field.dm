...
//#DEFINE MAX_STORED_ENERGY (held_plasma.phoron * held_plasma.phoron * SPECIFIC_HEAT_TOXIN)
...
/obj/effect/rust_em_field/process()
	...
	if(held_plasma.phoron < transfer_ratio * 1000)
		...
		//world << "\blue[plasma_captured.phoron] moles of plasma captured"
	...
	//SPECIFIC_HEAT_TOXIN
	if(mega_energy > 0 && held_plasma.phoron)
	...
	/*if( held_plasma.phoron > (MOLES_CELLSTANDARD * 7) * (50 / field_strength) )
		LosePlasma()*/
	if(held_plasma.phoron > 1)
